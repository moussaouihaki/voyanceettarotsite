...
export const metadata: Metadata = {
  ...
  description: "Recevez les messages des anges gardiens. Guidance angélique personnalisée par Madame Céleste — révélations célestes, affirmations et guidance spirituelle profonde.",
