...
export const metadata: Metadata = {
  ...
  description:
    "Le pendule virtuel de Madame Céleste — choisissez votre cristal (améthyste, quartz, obsidienne…) et posez votre question. Réponse Oui/Non guidée par radiesthésie numérique et cristallothérapie.",
