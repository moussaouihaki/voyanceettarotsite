...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/cartomancie", label: "Cartomancie", desc: "Jeu de 32 cartes · Tradition populaire", premium: true },
      { href: "/anges", label: "Oracle des Anges", desc: "Messages célestes · Guidance angélique", premium: true },
      { href: "/pendule", label: "Pendule Virtuel", desc: "Réponses intuitives · Radiesthésie" },
      { href: "/tasseomancie", label: "Tasséomancie", desc: "Lecture du marc de café · Tradition orientale", premium: true },
    ],
  },
  {
    label: "Énergies",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/bibliomancie", label: "Bibliomancie", desc: "L'oracle des textes sacrés", premium: true },
