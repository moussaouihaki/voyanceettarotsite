...
export const CARTOMANCIE_DECK: CartomancieCard[] = [
  // ══════════ CŒUR ♥ ══════════
  {
    ...
    name: "7 de Cœur",
    keywords: ["pensées", "réflexion", "flatterie", "indécision"],
    upright: "Une pensée ou une préoccupation légère occupe l'esprit. Les flatteries peuvent voiler la vérité.",
    love: "Des pensées tendres circulent, mais méfiez-vous des paroles dorées sans actes.",
    work: "Une idée germe, mais l'hésitation freine l'action — décidez-vous.",
    red: true,
  },
  {
    id: "coeur-8", suit: "coeur", suitSymbol: "♥", suitName: "Cœur", rank: "8",
    name: "8 de Cœur",
    keywords: ["invitation", "visite", "fête", "joie sociale"],
    upright: "Une invitation ou une réunion joyeuse est à venir. La vie sociale s'anime et porte bonheur.",
    love: "Une rencontre ou une sortie à deux ravivera la flamme du couple.",
    work: "Un événement professionnel ou une réunion favorable ouvre des portes.",
    red: true,
  },
  {
...
export function drawCartomancie(count: number): CartomancieCard[] {
  const shuffled = [...CARTOMANCIE_DECK].sort(() => Math.random() - 0.5);
  return shuffled.slice(0, Math.min(count, CARTOMANCIE_DECK.length));
}
