...
export const ELDER_FUTHARK: Rune[] = [
  ...
  { id: "mannaz", symbol: "ᛗ", name: "Mannaz", phonetic: "M", number: 20, element: "Air", deity: "Odin/Heimdall", keywords: ["humanité", "soi", "coopération", "intelligence"], upright: "Conscience de soi, coopération, intelligence, humanité dans son ensemble.", meaningReversed: "Égoïsme, isolation, manque de perspicacité.", meaning: "La rune de l'humanité. Symbolise l'être humain dans sa globalité et sa conscience." },
  { id: "laguz", symbol: "ᛚ", name: "Laguz", phonetic: "L", number: 21, element: "Eau", deity: "Njord", keywords: ["intuition", "inconscient", "flux", "émotions"], upright: "Flux, intuition, émotions profondes. Faites confiance à votre ressenti.", meaningReversed: "Confusion émotionnelle, peurs aquatiques, déni de l'intuition.", meaning: "La rune de l'eau. Symbolise le flux émotionnel, l'intuition et l'inconscient." },
