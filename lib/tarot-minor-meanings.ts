...
export const MINOR_MEANINGS: Record<string, MinorMeaning> = {
  ...
  "minor-épées-10": { keywords: ["fin douloureuse", "trahison ultime", "rock bottom"], upright: "Le fond du puits. Trahison totale, fin brutale — mais l'aube se lève à l'horizon.", reversed: "Renaissance, fin du calvaire, premier souffle nouveau." },
  ...
  "minor-pentacles-13": { keywords: ["abondance maternelle", "pragmatisme", "nourrir les autres"], upright: "Reine de Deniers — femme nourricière, généreuse, ancrée. Sécurité matérielle.", reversed: "Matérialisme excessif, négligence de soi, dépendance, smother." },
