...
export const ALL_SPREADS: Spread[] = [
  ...
  // ─── SPIRITUEL ───────────────────────────────────────────────────────────────
  {
    id: "shadow-work", name: "Shadow Work", subtitle: "Explorer l'ombre intérieure",
    cardCount: 5, category: "spirituel", difficulty: "avancé", emoji: "🌑",
    positions: ["Votre ombre principale", "Son origine", "Comment elle se manifeste", "Ce qu'elle vous enseigne", "Comment l'intégrer"],
    description: "Plongez dans le travail sur l'ombre pour une transformation profonde.",
  },
  {
  ...
  {
    id: "nouvelle-lune", name: "Tirage Nouvelle Lune", subtitle: "Intentions & nouveaux départs",
    cardCount: 6, category: "spirituel", difficulty: "intermédiaire", emoji: "🌑",
    positions: ["Ce que vous voulez manifester", "Ce dont vous avez besoin", "Ce qui vous aide", "Ce qui vous freine", "L'action à entreprendre", "Ce que la Lune vous promet"],
    description: "Plantez vos intentions sous l'énergie de la Nouvelle Lune.",
  },
  {
    id: "pleine-lune", name: "Tirage Pleine Lune", subtitle: "Lâcher prise & accomplissement",
    cardCount: 6, category: "spirituel", difficulty: "intermédiaire", emoji: "🌕",
    positions: ["Ce qui est accompli", "Ce que vous devez célébrer", "Ce que vous devez libérer", "Ce qui vous retient encore", "La gratitude à exprimer", "Le message de la Pleine Lune"],
    description: "Honorez ce qui est accompli et libérez ce qui ne vous sert plus.",
  },
  {
